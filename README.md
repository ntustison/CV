...
59\. Andrew T. Grainger, __Nicholas J. Tustison__, Kun Qing, Rene Roy, Stuart S. Berr, and Weibin Shi.  Deep learning-based quantification of abdominal fat on magnetic resonance images. _PLOS ONE_.  [Accepted](https://bitbucket.org/atg3qz/unet_fat_mri/src/master/)
 
58\. __Nicholas J. Tustison__, Brian B. Avants, Zixuan Lin, Xue Feng, Nicholas Cullen, Jaime F. Mata, Lucia Flors, James C. Gee, Talissa A. Altes, John P. Mugler III, and Kun Qing.  Convolutional Neural Networks with Template-Based Data Augmentation for Functional Lung Image Quantification, _Academic Radiology_. [In Press](https://www.sciencedirect.com/science/article/pii/S1076633218303878?via%3Dihub)
